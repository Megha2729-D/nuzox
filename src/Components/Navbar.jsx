...
const Navbar = () => {
    ...
    return (
        <nav className="nuzox_navbar flex-column w-100">
            <div className="bg-yellow text-black py-1 d-flex align-items-center overflow-hidden">
            ...
            <div className={`navbar_links section_container ${active ? "active" : ""}`}>
                <div className="nav_parent py-3">
                    ...
                    <div className="logo">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/nuzox-logo-black.webp`} alt="" />
                    </div>
                    <div className={`nav-elements  ${showNavbar && "active"}`}>
                        <ul className="mb-0 ps-lg-0">
                            ...
                            <li>
                                <NavLink to="/sample">T Shirts</NavLink>
                            </li>
                            <li>
                                <NavLink to="/sample">Pants</NavLink>
                            </li>
                            <li>
                                <NavLink to="/sample">Hoodies</NavLink>
                            </li>
                            <li>
                                <NavLink to="/sample">Shorts</NavLink>
                            </li>
                            <li>
                                <NavLink to="/sample">Polo</NavLink>
                            </li>
                            <li>
                                <NavLink to="/sample">Track Pant</NavLink>
                            </li>
                        </ul>
